...
const Home = () => {
  return (
    <>
      <div
        className=" container rounded   px-5 py-4  "
        id="home"
        style={{
          margin: "100px auto",
        }}
      >
        <div className="neu-div card bg-dark">
            ...
            <div className="row ">
              ...
              <div className="col-md-6 col-12 ps-5  mt-3 order-md-first">
                ...
                <p className="text-white fs-3">
                  ...
                  <a
                    href="https://twitter.com/mayank_html"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-info pe-4"
                  >
                  ...
                  <a
                    href="https://www.instagram.com/mayank_html/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-info pe-4"
                  >
